...
namespace YouAreNotAlone
{
    public class Racer : Nitroable
    {
        ...
        public bool IsCreatedIn(float radius, Road road)
        {
            ...
            {
                if (spawnedVehicle.Model.IsCar) Util.AddBlipOn(spawnedPed, 0.7f, BlipSprite.PersonalVehicleCar, (BlipColor)17, "Racer " + Util.GetVehicleName(spawnedVehicle));
                else Util.AddBlipOn(spawnedPed, 1.0f, BlipSprite.PersonalVehicleBike, (BlipColor)17, "Racer " + Util.GetVehicleName(spawnedVehicle));
